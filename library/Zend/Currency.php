 ...
 * @version   $Id: //p4-wdpro/Projects/NGE/Sites/pep/main/src/library/Zend/Currency.php#3 $
 */
...
class Zend_Currency
{
    ...
    {
        // If no $locale is provided, check in the Zend_Registry for the default one
        if (null === $locale && Zend_Registry::isRegistered('locale')) {
            // ...and use it if set
